...
\item{Work in collaboration with the space sciences research group at Chalmers University of Technology to irradiate Si wafers used in Bolometers}
\item{Bachelor Thesis Co-supervisor}
\subitem{\underline{Title:} Development of Nuclear Security Nondestructive Detection System: Study of the Feynman}
\subitem{Variance to Mean Method and GaN based Semiconductor Circuit}
\subitem{\underline{Students:} Fredrik Carlsson, Daniel Fahlgren, Nermin Trnjanin}
\item{\textit{Teaching:} Radiation measurements laboratory}
\end{itemize}}
%\sepspace

\NewPart{Previous Positions}{}
